---
title: "OpenTelemetry Integration: Distributed Tracing for FalkorDB"
...
<AccordionGroup>
  <Accordion title="Which OpenTelemetry packages do I need for FalkorDB tracing?">
  ...
  <Accordion title="Can I use OpenTelemetry with FalkorDB in production?">
  ...
  <Accordion title="Does OpenTelemetry add performance overhead to FalkorDB queries?">
  ...
  <Accordion title="How do I avoid logging sensitive data in spans?">
  ...
  <Accordion title="Can I trace FalkorDB queries across multiple services?">
