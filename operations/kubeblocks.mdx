---
title: "Managing FalkorDB on Kubernetes with KubeBlocks"
sidebarTitle: "KubeBlocks"
...
<AccordionGroup>
  <Accordion title="What Kubernetes version does KubeBlocks require?">
    KubeBlocks requires Kubernetes >= v1.21. Ensure you also have `kubectl` and `helm` installed before deploying.
  </Accordion>
  <Accordion title="What topologies does KubeBlocks support for FalkorDB?">
  ...
  <Accordion title="How do I scale my FalkorDB cluster with KubeBlocks?">
  ...
  <Accordion title="Does KubeBlocks support automated backups?">
  ...
  <Accordion title="How do I connect to FalkorDB deployed with KubeBlocks?">
