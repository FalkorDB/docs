---
title: "Deploy FalkorDB with Docker and Docker Compose"
sidebarTitle: "Docker"
...
<AccordionGroup>
  <Accordion title="What is the difference between falkordb/falkordb and falkordb/falkordb-server images?">
  ...
  <Accordion title="How do I set a password for FalkorDB in Docker?">
  ...
  <Accordion title="How do I configure FalkorDB module parameters like thread count?">
  ...
  <Accordion title="Why is my data lost when I restart the container?">
  ...
  <Accordion title="How do I check if FalkorDB is healthy in Docker Compose?">
