---
title: "Deploying FalkorDB on Lightning.AI for GenAI Applications"
sidebarTitle: "Lightning.AI"
...
<AccordionGroup>
  <Accordion title="What is FalkorDB on Lightning.AI best suited for?">
  ...
  <Accordion title="Do I need to install FalkorDB separately on Lightning.AI?">
  ...
  <Accordion title="Can I use FalkorDB on Lightning.AI for production workloads?">
    Lightning.AI is excellent for prototyping and building AI applications. For production graph database workloads, consider [FalkorDB Cloud](https://app.falkordb.cloud) or self-hosted deployments with Docker or Kubernetes.
  </Accordion>
  <Accordion title="How does FalkorDB enhance RAG applications?">
