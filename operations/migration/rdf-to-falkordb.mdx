---
title: "RDF to Property Graph Migration Guide"
sidebarTitle: "RDF to FalkorDB"
...
keywords:
  - "RDF to property graph"
  - "triplestore alternative"
  - "RDF migration"
  - "convert TTL to graph database"
  - "SPARQL to Cypher migration"
---
...
<AccordionGroup>
  <Accordion title="How does the RDF to FalkorDB migration handle RDF triples?">
  ...
  <Accordion title="What RDF formats are supported?">
  ...
  <Accordion title="Should I use the Python loader or the Rust loader?">
    Use the Python loader for small to medium datasets. For large datasets (millions of triples), use the [FalkorDB Rust Loader](https://github.com/FalkorDB/FalkorDB-Loader-RS) for significantly better performance with async operations and streaming.
  </Accordion>
  <Accordion title="What does URI shortening do?">
  ...
  <Accordion title="Can I customize how RDF types map to FalkorDB labels?">
