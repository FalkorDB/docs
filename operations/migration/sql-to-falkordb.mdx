---
title: "SQL to Graph: Online Migration & Continuous Sync"
sidebarTitle: "SQL to FalkorDB"
...
keywords:
  - "SQL to graph database"
  - "relational to graph migration"
  - "PostgreSQL to graph database"
  - "Snowflake to graph database"
  - "CDC sync to graph database"
---
...
<AccordionGroup>
  <Accordion title="Which SQL sources are supported for migration to FalkorDB?">
  ...
  <Accordion title="Can I run continuous sync from SQL to FalkorDB?">
  ...
  <Accordion title="How do I map SQL tables to a graph model?">
  ...
  <Accordion title="What is the control plane and do I need it?">
  ...
  <Accordion title="Can I purge and reload data during migration?">
