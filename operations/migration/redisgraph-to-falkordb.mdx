---
title: "Migrating from RedisGraph to FalkorDB (Official Successor)"
sidebarTitle: "RedisGraph"
...
<AccordionGroup>
  ...
  <Accordion title="Will my existing RedisGraph client code work with FalkorDB?">
    Yes. FalkorDB is API-compatible with RedisGraph. Your existing client code using `GRAPH.QUERY` and `GRAPH.RO_QUERY` commands will work without modifications.
  </Accordion>
</AccordionGroup>
