---
title: "Graphiti: Dynamic Temporal Knowledge Graph Memory for AI Agents"
sidebarTitle: "Graphiti"
...
- Explore [Cognee](/agentic-memory/cognee) for alternative memory management approaches
- Learn about [GenAI Tools](/genai-tools) for graph reasoning and LLM integrations

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="What does 'temporally-aware' mean in the context of Graphiti?">
  ...
  <Accordion title="How do I connect Graphiti to FalkorDB?">
  ...
  <Accordion title="What is an 'episode' in Graphiti?">
  ...
  <Accordion title="How does multi-tenancy work in Graphiti with FalkorDB?">
  ...
  <Accordion title="Do I need to call build_indices_and_constraints every time I run my application?">
