---
title: "Mem0: Personalized Agentic Memory Powered by FalkorDB"
sidebarTitle: "Mem0"
...
- Add this memory to an [OpenClaw](/agentic-memory/openclaw) assistant with the `@falkordb/openclaw-mem0` plugin
