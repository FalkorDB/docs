---
title: "PyTorch Geometric Integration: Graph Neural Networks with FalkorDB"
sidebarTitle: "PyTorch Geometric"
...
<AccordionGroup>
  <Accordion title="What is falkordb-pyg used for?">
  ...
  <Accordion title="What are the minimum version requirements?">
  ...
  <Accordion title="Does falkordb-pyg support heterogeneous graphs?">
  ...
  <Accordion title="How does node ID remapping work?">
  ...
  <Accordion title="Can I use standard PyG data loaders with this backend?">
