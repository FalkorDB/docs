---
title: "FalkorDB Bulk Loader: High-Speed CSV Ingestion for Large Graphs"
sidebarTitle: "Bulk Loader"
...
<AccordionGroup>
  <Accordion title="How much faster is the bulk loader compared to individual CREATE queries?">
  ...
  <Accordion title="What Python version is required for the bulk loader?">
    The falkordb-bulk-loader requires **Python 3.10 or later**. Install it with `pip install falkordb-bulk-loader`.
  </Accordion>
  <Accordion title="How are node labels and relationship types determined from CSV files?">
  ...
  <Accordion title="Can I update existing data with the bulk loader?">
  ...
  <Accordion title="What data types are supported in schema-enforced mode?">
