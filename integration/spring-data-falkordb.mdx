---
title: "Spring Data FalkorDB: Java Object-Graph Mapping Reference"
sidebarTitle: "Spring Data"
...
<AccordionGroup>
  <Accordion title="What annotations does Spring Data FalkorDB support?">
  ...
  <Accordion title="How do I define a repository for my graph entities?">
  ...
  <Accordion title="Does Spring Data FalkorDB support derived query methods?">
  ...
  <Accordion title="What dependencies do I need in my Maven project?">
  ...
  <Accordion title="Does Spring Data FalkorDB support transactions?">
