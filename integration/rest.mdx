---
title: "FalkorDB REST API: HTTP Interface for Graph Queries"
...
<AccordionGroup>
  <Accordion title="How do I authenticate with the FalkorDB REST API?">
  ...
  <Accordion title="What is the ENCRYPTION_KEY and why is it required?">
  ...
  <Accordion title="What operations can I perform through the REST API?">
  ...
  <Accordion title="What data types are supported for node/edge attributes?">
  ...
  <Accordion title="Can I use the REST API for production workloads?">
