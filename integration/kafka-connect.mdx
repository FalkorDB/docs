---
title: "Kafka Connect FalkorDB Sink: Real-Time Event Stream Ingestion"
...
<AccordionGroup>
  <Accordion title="How do I get the FalkorDB Kafka Connect sink connector?">
    You can either build it from [source](https://github.com/FalkorDB/falkordb-kafka-connect) or download the pre-built uber JAR from the [GitHub releases](https://github.com/FalkorDB/falkordb-kafka-connect/releases).
  </Accordion>
  <Accordion title="What message format does the connector expect?">
  ...
  <Accordion title="Can the connector write to multiple graphs from a single topic?">
  ...
  <Accordion title="What converters should I use for key and value serialization?">
  ...
  <Accordion title="How do I scale the connector for higher throughput?">
