...
{% include faq_accordion.html
  ...
  a5="Create **indexes** on frequently queried properties, use specific labels in MATCH clauses, limit result sets for exploration queries, and batch large loads into smaller transactions to avoid timeouts."
%}
2