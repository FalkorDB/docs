...
[Structured Ingestion](/graphrag/structured-ingestion): you declare what the columns mean
...
For a detailed explanation of the extraction process, see [Extraction](/graphrag/extraction).
...
For details on resolution strategies, see [Strategies](/graphrag/strategies).
...
For details on the storage layer, see [Storage](/graphrag/storage).
