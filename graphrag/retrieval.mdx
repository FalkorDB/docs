...
This document explains how each path works, what it contributes, and how they perform individually and together. See [Reducing LLM Hallucinations](/graphrag/reducing-llm-hallucinations) for how this multi-path strategy grounds answers in retrieved evidence and how to inspect that evidence at answer time.
