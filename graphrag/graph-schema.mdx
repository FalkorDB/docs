...
Looking to *change* an existing ontology — add/drop attributes, rename labels, retype fields? See [Ontology Evolution](/graphrag/ontology-evolution) for the atomic-evolve API and the alignment invariant it enforces.
