...
<Card title="Reducing LLM Hallucinations" icon="shield-check" href="/graphrag/reducing-llm-hallucinations">
...
- [Reducing LLM Hallucinations](/graphrag/reducing-llm-hallucinations) -- Grounded retrieval, provenance, and abstention
