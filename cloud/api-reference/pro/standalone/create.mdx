...
Provisions a new Pro Standalone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/pro/standalone/describe) until `status` is `RUNNING`.
