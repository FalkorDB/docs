...
Provisions a new Pro Single-Zone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/pro/single-zone/describe) until `status` is `RUNNING`.
