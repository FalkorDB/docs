...
Provisions a new Pro Cluster (Multi-Zone) instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/pro/cluster-multi-zone/describe) until `status` is `RUNNING`.
