...
Provisions a new Enterprise BYOA Cluster (Multi-Zone) instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/enterprise-byoa/cluster-multi-zone/describe) until `status` is `RUNNING`.
