...
Provisions a new Enterprise BYOA Standalone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/enterprise-byoa/standalone/describe) until `status` is `RUNNING`.
