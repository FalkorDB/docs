...
Provisions a new Enterprise Standalone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/enterprise/standalone/describe) until `status` is `RUNNING`.
