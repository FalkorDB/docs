...
Provisions a new Enterprise Cluster (Multi-Zone) instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/enterprise/cluster-multi-zone/describe) until `status` is `RUNNING`.
