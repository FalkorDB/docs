...
Provisions a new Enterprise Multi-Zone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/cloud/api-reference/enterprise/multi-zone/describe) until `status` is `RUNNING`.
