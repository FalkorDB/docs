...
![FalkorDB Cloud Enterprise Tier Banner](https://github.com/user-attachments/assets/f03bb001-1916-4e0f-9a82-cb8271309855)
...
{% include faq_accordion.html title="Frequently Asked Questions" q1="How is Enterprise Tier pricing determined?" a1="Enterprise pricing is **custom** and based on your specific configuration of cores, memory, and additional enterprise components. [Contact our Sales Team](https://www.falkordb.com/get-a-demo/) for a tailored quote." q2="Is Azure available on the Enterprise Tier?" a2="Yes, the Enterprise Tier supports **AWS, GCP, and Azure** (via Bring-Your-Own-Cloud). This is the only tier that offers Azure deployment." q3="What is VPC Peering and why does it matter?" a3="VPC Peering connects your FalkorDB instance to your private network, making it accessible only via private IPs. This eliminates public internet exposure and is critical for compliance-sensitive workloads." q4="How often are automated backups taken?" a4="Enterprise Tier includes automated backups **every hour**, providing the highest backup frequency among all tiers. This minimizes potential data loss to under one hour." q5="What support level is included?" a5="Enterprise customers receive **dedicated support** with a **dedicated account manager**, priority response times, and tailored SLAs to meet your operational requirements." %}
