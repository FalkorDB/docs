...
<AccordionGroup>
  <Accordion title="How is Enterprise Tier pricing determined?">
    Enterprise pricing is **custom** and based on your specific configuration of cores, memory, and additional enterprise components. [Contact our Sales Team](https://www.falkordb.com/get-a-demo/) for a tailored quote.
  </Accordion>
  <Accordion title="Is Azure available on the Enterprise Tier?">
    Yes, the Enterprise Tier supports **AWS, GCP, and Azure** (via Bring-Your-Own-Cloud). This is the only tier that offers Azure deployment.
  </Accordion>
  <Accordion title="What is VPC Peering and why does it matter?">
    VPC Peering connects your FalkorDB instance to your private network, making it accessible only via private IPs. This eliminates public internet exposure and is critical for compliance-sensitive workloads.
  </Accordion>
  <Accordion title="How often are automated backups taken?">
    Enterprise Tier includes automated backups **every hour**, providing the highest backup frequency among all tiers. This minimizes potential data loss to under one hour.
  </Accordion>
  <Accordion title="What support level is included?">
    Enterprise customers receive **dedicated support** with a **dedicated account manager**, priority response times, and tailored SLAs to meet your operational requirements.
  </Accordion>
</AccordionGroup>
