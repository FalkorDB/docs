---
title: "FalkorDB License: Server Side Public License (SSPLv1)"
...
<AccordionGroup>
  <Accordion title="What does it mean that FalkorDB is licensed under SSPLv1?">
  ...
  <Accordion title="Can I use FalkorDB in my internal projects without open-sourcing my code?">
  ...
  <Accordion title="Can I use FalkorDB in my closed-source project without open-sourcing the entire project?">
  ...
  <Accordion title="How does the SSPLv1 license affect my commercial application that uses FalkorDB?">
  ...
  <Accordion title="What if I want to use FalkorDB in my product but don\u2019t want to release my source code?">
  ...
  <Accordion title="Does the SSPLv1 license affect FalkorDB\u2019s SDKs and other libraries?">
  ...
  <Accordion title="Can I modify FalkorDB under the SSPLv1 license?">
  ...
  <Accordion title="Can I redistribute FalkorDB in my applications without following SSPLv1?">
  ...
  <Accordion title="What should I do if I\u2019m unsure whether SSPLv1 affects my use of FalkorDB?">
  ...
  <Accordion title="Is FalkorDB free to use for evaluation and prototyping?">
