---
title: "coll.intersection: List Intersection in Cypher"
sidebarTitle: "coll.intersection"
...
## See Also
- [coll.union](/udfs/flex/collections/union) - Combine all unique elements from both lists
- [sim.jaccard](/udfs/flex/similarity/jaccard) - Calculate similarity coefficient using intersection

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="What does flex.coll.intersection return?">
    It returns a list containing only the elements that appear in **all** of the input lists.
  </Accordion>
  <Accordion title="Does intersection preserve duplicates?">
