...
{% include faq_accordion.html
  ...
  q1="What does flex.bitwise.xor return?"
  a1="It returns an integer where each bit is 1 only if the corresponding bits in the two operands differ. For example, `flex.bitwise.xor(5, 3)` returns `6`."
  q2="What is XOR commonly used for?"
  a2="XOR is useful for toggling flags, simple checksums, and detecting differences between two bitmasks."
%}
