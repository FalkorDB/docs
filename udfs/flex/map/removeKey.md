...
{% include faq_accordion.html title="Frequently Asked Questions" q1="Does flex.map.removeKey modify the original map?" a1="No. It returns a new map with the specified key removed, leaving the original unchanged." q2="What happens if the key does not exist?" a2="The function returns a copy of the original map unchanged — no error is thrown." %}
