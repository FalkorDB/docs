---
title: "text.regexGroups: Extracting Regex Capture Groups in Cypher"
sidebarTitle: "text.regexGroups"
...
## See Also
- [text.replace](/udfs/flex/text/replace) - Replace text using regex
- [text.indexOf](/udfs/flex/text/indexOf) - Find simple substring position
- [text.indexesOf](/udfs/flex/text/indexesOf) - Find all substring positions

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="What does the nested array structure look like?">
  ...
  <Accordion title="Does regexGroups find all matches or just the first?">
