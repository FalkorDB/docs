---
title: "text.join: Joining String Arrays with Delimiters in Cypher"
sidebarTitle: "text.join"
...
<AccordionGroup>
  ...
  <Accordion title="Can the flex.text.join delimiter be an empty string?">
