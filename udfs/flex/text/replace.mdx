---
title: "text.replace: Regex Pattern Replacement in Cypher"
sidebarTitle: "text.replace"
...
<AccordionGroup>
  ...
  <Accordion title="Does flex.text.replace replace all occurrences or just the first?">
