...
All the logic described in this document has been implemented in most of the clients listed in [Client Libraries](/getting-started/clients). Among these, `node-redis`, `redis-py` and `jedis` are currently the most sophisticated.
