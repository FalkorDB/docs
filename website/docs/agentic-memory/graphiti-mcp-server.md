...
sidebar_position: 3
sidebar_label: Graphiti MCP Server
---
...
All data is stored in a graph named `graphiti_memory`

## Advanced Usage

### Programmatic Access

> **⚠️ Important**: The Graphiti MCP server is designed to be used by MCP clients (like Claude Desktop or Cursor) via the HTTP transport protocol. It does **not** expose direct REST API endpoints outside of the MCP protocol.
