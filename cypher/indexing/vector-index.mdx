---
title: "Vector Indexing: Fast Similarity Search for GraphRAG"
sidebarTitle: "Vector Index"
description: "FalkorDB supports vector indexes for similarity search on vector embeddings, essential for AI and machine learning applications."
---
...
<AccordionGroup>
  <Accordion title="What similarity functions are supported for vector indexes?">
  ...
  <Accordion title="How do I query a vector index?">
  ...
  <Accordion title="What vector dimensions are supported?">
  ...
  <Accordion title="Can I create vector indexes on relationships?">
  ...
  <Accordion title="How do I improve vector search recall?">
