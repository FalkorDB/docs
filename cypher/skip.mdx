---
title: "SKIP Clause: Pagination Offsets in Cypher"
sidebarTitle: "SKIP"
description: "The optional skip clause allows a specified number of records to be omitted from the result set."
---
