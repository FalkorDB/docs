---
title: "LOAD CSV Clause: Importing Tabular Data into FalkorDB"
sidebarTitle: "LOAD CSV"
description: "Load CSV files into FalkorDB with LOAD CSV clause for data import. Supports local files, remote HTTPS URLs, headers, custom delimiters, and batch processing."
---
