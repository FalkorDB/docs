---
title: "RETURN Clause: Projecting Graph Query Results"
sidebarTitle: "RETURN"
description: "Define result-set properties with the RETURN clause in Cypher queries. Support for DISTINCT, aggregations (COUNT, SUM, AVG), and implicit GROUP BY functionality."
---
...
<AccordionGroup>
  ...
  <Accordion title="Can I return all properties of a node?">
  ...
  <Accordion title="What aggregation functions are available?">
