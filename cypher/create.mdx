---
title: "CREATE Clause: Adding Nodes and Relationships in Cypher"
sidebarTitle: "CREATE"
description: "Use the CREATE clause to add new nodes and relationships to FalkorDB graphs. Create single or multiple entities, set properties and labels, and build complete graph patterns."
---
