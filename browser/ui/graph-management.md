...
| Export graph | Download a `.dump` file through `/api/graph/:graph/export`. |
...
{% include faq_accordion.html
  ...
  a1="Yes. Select a graph and use Export to download a `.dump` file via `/api/graph/:graph/export`."
