---
title: "LangGraph Integration: Stateful Multi-Agent Workflows with FalkorDB"
...
<AccordionGroup>
  <Accordion title="What is LangGraph and how does it work with FalkorDB?">
  ...
  <Accordion title="How does LangGraph differ from LangChain for FalkorDB?">
  ...
  <Accordion title="Can I add error recovery to my graph queries?">
  ...
  <Accordion title="Does LangGraph support conversation memory with FalkorDB?">
  ...
  <Accordion title="What are good use cases for LangGraph with FalkorDB?">
