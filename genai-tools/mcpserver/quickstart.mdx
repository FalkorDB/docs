---
title: "FalkorDB MCP Server Quick Start: Connect AI Assistants to Graph"
...
<AccordionGroup>
  <Accordion title="What do I need to get started with the FalkorDB MCP Server?">
  ...
  <Accordion title="How do I connect Claude Desktop to FalkorDB?">
  ...
  <Accordion title="Can I run the MCP Server without Claude Desktop?">
  ...
  <Accordion title="How do I use Docker Compose for a full setup?">
  ...
  <Accordion title="What can I ask Claude once connected to FalkorDB?">
