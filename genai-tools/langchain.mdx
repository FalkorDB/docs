---
title: "LangChain Integration: Building GraphRAG and AI Agents"
...
- **`FalkorDBSaver`** — a [LangGraph](/genai-tools/langgraph) checkpointer that persists agent state in FalkorDB.
...
<AccordionGroup>
  <Accordion title="What languages does the FalkorDB LangChain integration support?">
  ...
  <Accordion title="How do I connect LangChain to FalkorDB?">
  ...
  <Accordion title="Can I use FalkorDB as a vector store with LangChain?">
  ...
  <Accordion title="What is FalkorDBQAChain?">
  ...
  <Accordion title="Can I give agents persistent memory with FalkorDB?">
