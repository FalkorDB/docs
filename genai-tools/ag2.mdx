---
title: "AG2 (AutoGen) Integration: Multi-Agent Systems with GraphRAG"
sidebarTitle: "AG2"
...
<AccordionGroup>
  <Accordion title="What is AG2 and how does it integrate with FalkorDB?">
  ...
  <Accordion title="How do I install AG2 with FalkorDB support?">
  ...
  <Accordion title="What is FalkorGraphRagCapability?">
  ...
  <Accordion title="Can multiple agents share the same knowledge graph?">
  ...
  <Accordion title="Does AG2 support human-in-the-loop workflows with FalkorDB?">
