...
Contributions are welcome! See the [Contributing Guidelines](https://github.com/FalkorDB/FalkorDB-MCPServer/blob/main/CONTRIBUTING.md) for details on how to get started.

---

*Built on the [Model Context Protocol SDK](https://github.com/anthropics/model-context-protocol) and powered by [FalkorDB](https://www.falkordb.com/)*
