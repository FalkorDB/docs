...
<AccordionGroup>
  ...
  <Accordion title="How do I install Graphify with FalkorDB support?">
    Install and register Graphify using the current command from the [Graphify README](https://github.com/Graphify-Labs/graphify/blob/main/README.md): `pip install graphifyy && graphify install`. For Codex, register with `graphify install --platform codex`.
  </Accordion>
