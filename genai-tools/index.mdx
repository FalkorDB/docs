...
- [GraphRAG Server](/genai-tools/graphrag-server): The hosted, no-code GraphRAG app. Upload your documents and chat with them at [graphrag.falkordb.com](https://graphrag.falkordb.com/).
