---
title: "Code-Graph: Visualizing Codebases as Knowledge Graphs"
sidebarTitle: "Code-Graph"
...
<AccordionGroup>
  <Accordion title="What is Code-Graph?">
  ...
  <Accordion title="Which programming languages does Code-Graph support?">
  ...
  <Accordion title="Can I ask questions about my codebase in natural language?">
  ...
  <Accordion title="How do I index a repository using the CLI?">
  ...
  <Accordion title="Do I need authentication to use Code-Graph?">
