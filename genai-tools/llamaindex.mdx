---
title: "LlamaIndex Integration: Knowledge Graph Indexing & GraphRAG"
...
<AccordionGroup>
  <Accordion title="What is LlamaIndex and how does it integrate with FalkorDB?">
  ...
  <Accordion title="How do I install LlamaIndex with FalkorDB support?">
  ...
  <Accordion title="Can I build a knowledge graph from unstructured documents?">
  ...
  <Accordion title="What is hybrid retrieval mode?">
  ...
  <Accordion title="Can I add new data without rebuilding the entire graph?">
