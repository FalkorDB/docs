...
![Graph BFS](/images/graph_bfs.webp)
...
<AccordionGroup>
  <Accordion title="What is the syntax for calling BFS in FalkorDB?">
    Use `CALL algo.bfs(start_node, max_depth, relationship) YIELD nodes, edges` where start_node is a matched node, max_depth is an integer, and relationship is an optional string filter.
  </Accordion>
