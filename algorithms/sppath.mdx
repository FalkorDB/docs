---
title: "Shortest Paths Between Nodes (algo.SPpaths) Graph Algorithm"
sidebarTitle: "algo.SPpaths"
...
![Road network](/images/road_network.webp)
...
<AccordionGroup>
  <Accordion title="What is the difference between weightProp and costProp?">
  ...
  <Accordion title="How do I get all shortest paths instead of just one?">
  ...
  <Accordion title="Can I search for paths in both directions?">
  ...
  <Accordion title="When should I use algo.SPpaths vs algo.SSpaths?">
    Use **algo.SPpaths** when you have a specific source *and* target node. Use **[algo.SSpaths](/algorithms/sspath)** when you want shortest paths from one source to *all* reachable destinations.
  </Accordion>
  <Accordion title="What happens if no path exists between source and target?">
