---
title: "Betweenness Centrality: Measuring Node Influence in Graphs"
sidebarTitle: "Betweenness Centrality"
...
![Social Graph](/images/between.webp)
...
<AccordionGroup>
  <Accordion title="What is the call syntax for Betweenness Centrality?">
  ...
  <Accordion title="Why do my results change between runs?">
  ...
  <Accordion title="How does samplingSize affect accuracy?">
  ...
  <Accordion title="When should I use Betweenness Centrality vs PageRank?">
    Use **Betweenness Centrality** to find *bridge* or *broker* nodes connecting different clusters. Use **[PageRank](/algorithms/pagerank)** to measure overall node *influence* based on incoming link quantity and quality.
  </Accordion>
  <Accordion title="Can Betweenness Centrality run on large graphs?">
