...
<AccordionGroup>
  <Accordion title="What is the syntax for running CDLP?">
  ...
  <Accordion title="How does CDLP differ from WCC?">
    **[WCC](/algorithms/wcc)** finds disconnected components (nodes unreachable from each other). **CDLP** detects *densely connected communities* within a connected graph by propagating labels iteratively.
  </Accordion>
  <Accordion title="Do I need to specify the number of communities in advance?">
  ...
  <Accordion title="What does the maxIterations parameter control in CDLP?">
  ...
  <Accordion title="Are CDLP results deterministic?">
